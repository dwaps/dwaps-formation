...
--
-- Client :  localhost
-- Généré le :  Jeu 19 Janvier 2017 à 18:40
...
--
CREATE DATABASE IF NOT EXISTS `dwaps` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dwaps`;
...
(39, 26, 'Mon environnement le plus récurrent', 'Selon l\'OS avec lequel je travail et en fonction &eacute;galement du type de projet que j\'ai &agrave; r&eacute;aliser j\'adapte bien s&ucirc;r mon environnement : tant&ocirc;t j\'utilise Gimp sous Linux ou Windows, tant&ocirc;t Photoshop, tant&ocirc;t j\'utilise Blender 3D, tant&ocirc;t Balsamiq, Android studio... Bref, la liste est longue !<br /><br />Malgr&eacute; cela, il y a quelques applications avec lesquelles je travaille &eacute;norm&eacute;ment et que je r&eacute;partis sur 4 &eacute;crans sous Linux et 2 &agrave; 3 &eacute;crans sous Windows. Voici la liste de ces applications :&nbsp;<br />\r\n<ul>\r\n<li>Le terminal</li>\r\n<li>Google Chrome</li>\r\n<li>Sublime Text</li>\r\n<li>L\'explorateur de fichier</li>\r\n</ul>\r\nJ\'utilise aussi souvent Firefox que Chrome pour la d&eacute;buggage, etc. Mais pour la recherche, je privil&eacute;gie Chrome qui me semble "s\'encrasser" moins vite que Firefox.<br /><br />Le script que je vous propose aura donc une mission toute simple : ouvrir mes applications et, pourquoi pas, m\'afficher un message de bienvenu.', 1);
...
(1, 'dwaps', 'dwaps', 'contact@dwaps.fr', 'contact@dwaps.fr', 1, NULL, '$2y$13$UXO9t59AOz7AGwkti38sf.PqwqEVnuaBExJrrUFGZGkY5jJdwDXdW', '2017-01-19 18:23:56', NULL, NULL, 'a:1:{i:0;s:16:"ROLE_SUPER_ADMIN";}');
